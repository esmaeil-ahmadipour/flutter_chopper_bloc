...
class _$Company extends Company {
  ...
  _$Company._({this.name, this.catchPhrase}) : super._() {
    if (name == null) {
  ...
  @override
  int get hashCode {
    return $jf($jc($jc(0, name.hashCode), catchPhrase.hashCode));
  }
...
class CompanyBuilder implements Builder<Company, CompanyBuilder> {
  ...
  _$Company build() {
    final _$result =
        _$v ?? new _$Company._(name: name, catchPhrase: catchPhrase);
    replace(_$result);
    return _$result;
  }
}
